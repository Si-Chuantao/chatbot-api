package com.sichuantao.chatbot.api.domain.zsxq.service;
...
import com.sichuantao.chatbot.api.domain.zsxq.model.req.AnswerReq;
import com.sichuantao.chatbot.api.domain.zsxq.model.req.ReqData;
import com.sichuantao.chatbot.api.domain.zsxq.model.res.AnswerRes;
...
public class ZsxqApi implements IZsxqApi {
    ...
    public UnAnsweredQuestionsAggregates queryUnAnsweredQuestionsTopicId(String groupId, String cookie) throws IOException {
        ...
        get.addHeader("cookie", cookie);// 自动写入cookie信息
